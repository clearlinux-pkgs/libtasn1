...
Version  : 4.18.0
Release  : 39
URL      : https://mirrors.kernel.org/gnu/libtasn1/libtasn1-4.18.0.tar.gz
Source0  : https://mirrors.kernel.org/gnu/libtasn1/libtasn1-4.18.0.tar.gz
Source1  : https://mirrors.kernel.org/gnu/libtasn1/libtasn1-4.18.0.tar.gz.sig
...
%prep
%setup -q -n libtasn1-4.18.0
cd %{_builddir}/libtasn1-4.18.0
pushd ..
cp -a libtasn1-4.18.0 build32
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1643756188
...
cp %{_builddir}/libtasn1-4.18.0/doc/COPYING %{buildroot}/usr/share/package-licenses/libtasn1/8624bcdae55baeef00cd11d5dfcfa60f68710a02
cp %{_builddir}/libtasn1-4.18.0/doc/COPYING.LESSER %{buildroot}/usr/share/package-licenses/libtasn1/01a6b4bf79aca9b556822601186afab86e8c4fbf
pushd ../build32/
%make_install32
...
/usr/lib64/libtasn1.so.6.6.2

%files lib32
%defattr(-,root,root,-)
/usr/lib32/libtasn1.so.6
/usr/lib32/libtasn1.so.6.6.2
